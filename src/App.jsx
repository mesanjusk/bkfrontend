...
// --- AESTHETIC MINIMAL THEME ---
const theme = createTheme({
  palette: {
    primary: { main: '#1a1a1a' }, // Deep Charcoal for a high-end feel
    background: { default: '#f8f9fa', paper: '#ffffff' },
    text: { primary: '#2d3436', secondary: '#636e72' },
  },
  shape: { borderRadius: 12 }, // Softer, modern corners
  typography: {
...
export default function App() {
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline /> {/* Reset CSS & apply theme background */}
      <AuthProvider>
        <LiveProvider>
          <BrowserRouter>
            <Routes>
