export const MODULE_PERMISSIONS = {
  ...
  superAdminSettings: '*',           // ← NEW — wildcard: only users with '*' (Super Admin) can access
};
...
export const APP_ROUTES = [
  ...
  { label: 'System Settings',  to: '/super-admin/settings', permission: MODULE_PERMISSIONS.superAdminSettings }, // ← NEW
];
